...
{
    public class HeaderGridWorker2
    {
        ...
        private void AddRows(
            IEnumerable<(string type, int level, string text)> rows)
        {
        ...
        private void AddRow((string type, int Level, string text) row)
        {
